...
tcp6       0      0 :::22                   :::*                    LISTEN     
tcp6       0      0 :::25                   :::*                    LISTEN     
root@ubuntu64:/# vim /etc
etc/        etc.tar.gz  
root@ubuntu64:/# vim /etc
etc/        etc.tar.gz  
root@ubuntu64:/# vim /etc/m
machine-id      mailcap         mdadm/          modprobe.d/     mtab            
magic           mailcap.order   mime.types      modules         mysql/          
magic.mime      manpath.config  mke2fs.conf     modules-load.d/ 
root@ubuntu64:/# vim /etc/m
machine-id      mailcap         mdadm/          modprobe.d/     mtab            
magic           mailcap.order   mime.types      modules         mysql/          
magic.mime      manpath.config  mke2fs.conf     modules-load.d/ 
